defmodule ConcertBotWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ConcertBotWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ConcertBotWeb.Gettext, "errors", msg, opts)
    end
  end
